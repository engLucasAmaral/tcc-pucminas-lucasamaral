package br.com.api.tcc.pmbd.dao;
...
public class DAO extends AbstractDao {
    ...
    public void setEntityManager(EntityManager entityManager) {
      ...
      public List<PessoaFisica> buscarTodos(String nome, String cpf, String email, Date nascimento) {

        CriteriaBuilder cb = entityManager.getCriteriaBuilder();
        CriteriaQuery q = cb.createQuery(PessoaFisica.class);
        Root<PessoaFisica> root = q.from(PessoaFisica.class);
        ...
        TypedQuery<PessoaFisica> qc = entityManager.createQuery(q);
