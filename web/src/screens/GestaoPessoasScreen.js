...
export default class AuditoriaScreen extends React.Component {
    ...
    submitForm = () => {
        console.log('aksjdkahdkjsahdasldjkashdsalk')
        this.setState({ loading: true });
        var URL = `${URL_BASE_AMBIENTE}/filtro?`;
        //   URL = `http://localhost:8080/pmbd/api/v1/pessoas/filtro?`
    ...
    render() {
        const { data, nome, cpf, email,  loading, edit } = this.state;
                    ...
                    <CardContainer>
                        ...
                        }
                        {
                            <DataTable
                                ...
                                style={{}}
                                // noDataComponent="Nenhum registro para exibir"
                            />
                        }
                    </CardContainer>
                </Content>
